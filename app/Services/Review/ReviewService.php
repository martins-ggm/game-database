...
class ReviewService implements IReviewService
{
    ...
    public function remover(int $id, int $usuarioID): void
    {
        ...
        $review = $this->reviewRepositorio->buscarReviewUsuario($id, $usuarioID);
    ...
    public function totalReviewDoUsuario(int $usuarioID): int
    {
        ...
        return $this->reviewRepositorio->totalReviewDoUsuario($usuarioID);
    }

    public function ReviewsDoUsuario(int $usuarioID, ?int $quantidade = null): Collection | LengthAwarePaginator
    {
        return $this->reviewRepositorio->ReviewsDoUsuario(usuarioID: $usuarioID, quantidade: $quantidade);
    }
}
